...
export default function AdminPublicationUpsertView() {
     const { errors, handleSubmit, isSubmitting, register, onFileChange, previewUrl } =
          useAdminPublicationUpsertHook();

     return (
          <div>
               <div className="lg:w-2/3">
                    <div className="text-3xl font-medium">New Publication</div>
