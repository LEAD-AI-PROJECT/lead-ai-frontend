"use client";
import useAdminPublicationUpsertByIdHook from "./admin.publication.upsert.id.hook";

type Props = Readonly<{ id: string }>;

export default function AdminPublicationUpsertByIdView({ id }: Props) {
     ...
     const {
          ...
          previewUrl,
          register,
     } = useAdminPublicationUpsertByIdHook();
     return (
          <div>
               <div className="lg:w-2/3">
                    <div className="text-3xl font-medium">Update Publication</div>
